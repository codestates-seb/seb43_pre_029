...
const App = () => {
  const [isLogin] = useState(localStorage.getItem('access_token'));
      ...
      <BrowserRouter>
        <Suspense fallback={<Loding />}>
          <Routes>
            ...
            <Route path={`/mypage/${m_id}`} element={<MyPage m_id={m_id} searchvalueBind={searchvalueBind} isSearchBind={isSearchBind} />} />
